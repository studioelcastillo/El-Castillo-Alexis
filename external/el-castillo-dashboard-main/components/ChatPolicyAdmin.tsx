...
import { ShieldCheck, Plus, Search, Info, Check, X, ShieldAlert, Users, Trash2, Megaphone, Zap, BookOpen, Settings, CheckCheck, AlertCircle, CheckCircle2, RefreshCw } from 'lucide-react';
...
import { ChatSettings, RoleChatPolicy } from '../types';
    ...
    const loadSavedPolicies = async () => {
      ...
      try {
        ...
        if (savedData && savedData.length > 0) {
          ...
          // Initialize empty
          roles.forEach(r => { newMatrix[r.id] = {}; });
