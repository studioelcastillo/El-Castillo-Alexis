...
const MOCK_ATTENDANCE = [
  { 
    id: 'a1', modelId: 'mod1', date: '2026-02-25', shiftId: 's1', 
    checkin: '06:05', checkout: '14:00', workedMinutes: 475, 
    lateMinutes: 5, missingMinutes: 5, minutesToPay: 20, 
    paid: false, penaltyApplied: true, penaltyAmount: 50000 
  },
  { 
    id: 'a2', modelId: 'mod2', date: '2026-02-25', shiftId: 's1', 
    checkin: '05:55', checkout: '14:05', workedMinutes: 490, 
    lateMinutes: 0, missingMinutes: 0, minutesToPay: 0, 
    paid: true, penaltyApplied: false, penaltyAmount: 0 
  }
];

const MOCK_CHART_DATA = [
  { name: 'Lun', meta: 642, real: 500 },
  { name: 'Mar', meta: 1284, real: 1100 },
  { name: 'Mié', meta: 1926, real: 1950 },
  { name: 'Jue', meta: 2568, real: 2400 },
  { name: 'Vie', meta: 3210, real: 3100 },
  { name: 'Sáb', meta: 3852, real: 3900 },
  { name: 'Dom', meta: 4500, real: 4200 },
];
