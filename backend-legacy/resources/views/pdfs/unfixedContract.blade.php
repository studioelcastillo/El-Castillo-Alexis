...
<head>
  ...
  <title>Contrato Individual de Trabajo a Término Indefinido</title>
  <style>
    * {
...
<body>
  ...
  <p>Las Partes, denominadas individualmente como la "Parte" y conjuntamente como las "Partes", han convenido celebrar el presente <b>CONTRATO INDIVIDUAL DE TRABAJO A TÉRMINO INDEFINIDO</b> (en adelante el "Contrato"), el cual se regirá por las siguientes cláusulas, previas las siguientes:</p>

  <h3>CONSIDERACIONES:</h3>

  <ul>
    <li>Que <b>EL EMPLEADOR</b> es una sociedad con experiencia en la gestión, producción, administración y comercialización de contenido digital y servicios de entretenimiento a través de diversas plataformas tecnológicas y canales en línea, y requiere personal calificado para el desarrollo de sus actividades.</li>

    <li>Que <b>EL TRABAJADOR</b> manifiesta contar con la capacidad, idoneidad y experiencia requeridas para desempeñar el cargo para el cual es contratado(a), y que ha sido informado(a) sobre la naturaleza de la actividad económica de <b>EL EMPLEADOR</b>, así como sobre los principios éticos y de conducta que rigen su operación.</li>

    <li>Que <b>EL TRABAJADOR</b> o desarrollo implica el acceso a información sensible, confidencial y estratégica de <b>EL EMPLEADOR</b>, así como la posible creación de obras y desarrollos de propiedad intelectual, lo que exige al <b>TRABAJADOR</b> un compromiso de absoluta lealtad, confidencialidad y ética para con <b>EL TRABAJADOR</b>.</li>

    <li>Que <b>EL TRABAJADOR</b> declara bajo la gravedad de juramento que no ha sido condenado(a) o vinculado(a) a procesos penales por delitos relacionados con pornografía infantil, trata de personas, prostitución infantil, abuso sexual de menores o cualquier otro delito contra la libertad, integridad y formación sexual, ni por lavado de activos o financiación del terrorismo, y se compromete a no realizar o participar en actividades ilícitas.</li>

    <li>Que <b>EL TRABAJADOR</b> ha recibido, leído, comprendido y acepta plenamente el <b>CÓDIGO DE CONDUCTA Y MANUAL DE CONVIVENCIA GENERAL</b> de <b>{{ strtoupper($studio->std_company_name) }}</b>, Y <b>REGLAMENTO INTERNO DE TRABAJO PARA EMPLEADOS</b> y la <b>POLÍTICA DE TRATAMIENTO DE DATOS PERSONALES (HABEAS DATA)</b> de <b>EL EMPLEADOR</b>, documentos que forman parte integral de este Contrato y cuyas disposiciones se obliga a cumplir.</li>
  </ul>

  <h3>CLÁUSULA PRIMERA: OBJETO DEL CONTRATO Y NATURALEZA DE LAS FUNCIONES</h3>

  <p><b>EL EMPLEADOR</b> contrata a <b>EL TRABAJADOR</b> para desempeñar el cargo de <b>{{$studioModel->stdmod_position ?? '[COLOCAR NOMBRE DEL CARGO/EMPLEADO CONTRATADO]'}}</b>.</p>
  ...
  <p class="indent">El colaborador prestará sus servicios en el Área Jurídica, siendo responsable de la redacción, revisión y validación de contratos, aplicación de cláusulas de confidencialidad, protección de datos personales, derechos de imagen y normativas SARLAFT. También será el encargado de brindar asesoría legal preventiva, de cobranza y representar jurídicamente a la empresa si se requiriera.</p>

  <p><b>Además de las funciones aquí descritas</b>, el colaborador podrá ser requerido para ejecutar otras tareas afines o complementarias dentro del mismo ámbito de trabajo, que correspondan a las necesidades operativas, estratégicas o administrativas de la empresa, aun cuando no estén expresamente detalladas en este contrato, siempre y cuando guarden relación con la naturaleza del área o el servicio contratado.</p>

  <p>ii. Todas aquellas actividades inherentes, conexas o complementarias a su cargo y naturaleza del negocio, que le sean asignadas por su superior jerárquico o la Dirección de la empresa, y que estén acordes con su capacidad, experiencia, formación y la evolución de las necesidades del servicio. iii. Cumplir con los objetivos y metas establecidas por <b>EL EMPLEADOR</b> en relación con su cargo y las políticas internas. iv. Acatar diligentemente las instrucciones, órdenes y directrices de <b>EL EMPLEADOR</b> en el desarrollo de sus funciones.</p>
  ...
  <p>El presente contrato de trabajo es a <b>TÉRMINO INDEFINIDO</b>, y comenzará a regir a partir del día<b> {{$studioModel->stdmod_start_at ? \Carbon\Carbon::parse($studioModel->stdmod_start_at)->format('d \d\e m \d\e Y') : '[DÍA] de [mes] de [AÑO]'}}</b>.</p>

  <p>Su duración se extenderá mientras subsistan las causas que le dieron origen y la necesidad del servicio para <b>EL EMPLEADOR</b>, sin perjuicio de las causales de terminación legalmente establecidas en el Código Sustantivo del Trabajo (CST) y las pactadas en el presente contrato.</p>

  <h3>CLÁUSULA TERCERA: PERIODO DE PRUEBA</h3>

  <p>Se pacta un período de prueba de <b>dos (2) meses</b>, contados a partir del inicio de la ejecución del presente Contrato. Durante este período, cualquiera de las Partes podrá dar por terminado el contrato unilateralmente, sin previo aviso y sin el pago de indemnización alguna, de conformidad con el artículo 78 del Código Sustantivo del Trabajo.</p>
  ...
  <p><b>EL TRABAJADOR</b> desempeñará sus funciones principalmente en las instalaciones de <b>EL EMPLEADOR</b> ubicadas en la <b>{{ strtoupper($studio->std_address ?? '[DIRECCIÓN DEL ESTUDIO]') }}</b>, o en el lugar que <b>EL EMPLEADOR</b> determine según las necesidades del servicio, siempre que no impliquen un desmejoramiento de las condiciones laborales de <b>EL TRABAJADOR</b>.</p>

  <p><b>EL EMPLEADOR</b> podrá, a su discreción y según la naturaleza del cargo, establecer o modificar la modalidad de prestación del servicio a teletrabajo o trabajo en casa, total o parcial, de conformidad con la Ley 1221 de 2008, Ley 2121 de 2021 y demás normas aplicables, garantizando las condiciones de seguridad y salud en el trabajo. En tal caso, se suscribirá el acuerdo respectivo y se observarán las condiciones que regulen dicha modalidad.</p>
  ...
  <p><b>EL TRABAJADOR</b> reconoce que la naturaleza de la actividad de <b>EL EMPLEADOR</b> puede requerir flexibilidad horaria, turnos rotativos, y trabajo en fines de semana o festivos, lo cual será remunerado de acuerdo con las disposiciones legales vigentes (recargos nocturnos, dominicales y festivos, horas extras).</p>

  <h3>CLÁUSULA SEXTA: SALARIO Y FORMA DE PAGO</h3>

  <p><b>EL EMPLEADOR</b> pagará a <b>EL TRABAJADOR</b> un salario mensual de <b>{{$studioModel->stdmod_monthly_salary ?? '[VALOR EN NÚMERO] $ [VALOR EN LETRA$] M/CTE.'}}</b>, pagaderos por períodos <b>QUINCENALES</b>, los días <b>16 y 1 de cada mes</b>, o último día hábil de cada mes, mediante <b>transferencia electrónica a la cuenta bancaria del trabajador, efectivo, etc.</b></p>
  ...
  <p>i. <b>Cumplimiento de Políticas y Reglamentos:</b> Acatar y cumplir estrictamente el <b>CÓDIGO DE CONDUCTA Y MANUAL DE CONVIVENCIA GENERAL</b> de <b>{{ strtoupper($studio->std_company_name) }}</b>, Y <b>REGLAMENTO INTERNO DE TRABAJO PARA EMPLEADOS</b> (aplicando las partes que le corresponden según su tipo de vinculación), y la <b>POLÍTICA DE TRATAMIENTO DE DATOS PERSONALES (HABEAS DATA)</b> de <b>EL EMPLEADOR</b>, documentos que ha recibido, leído, comprendido y acepta, y que forman parte integral del presente Contrato. La violación de cualquiera de las disposiciones se estos documentos se considerará un incumplimiento contractual y podrá dar lugar a las acciones disciplinarias y de terminación correspondientes. ii. <b>Diligencia y Profesionalismo:</b> Desempeñar sus funciones con la máxima diligencia, cuidado, profesionalismo, lealtad, ética y probidad, actuando siempre en el mejor interés de <b>EL EMPLEADOR</b>. iii. <b>Uso de Bienes y Recursos:</b> Utilizar de manera adecuada, eficiente y responsable los equipos, herramientas, sistemas informáticos, vehículos, materiales y demás bienes de <b>EL EMPLEADOR</b> puestos a su disposición para el desempeño de sus funciones, informando de inmediato cualquier daño, hurto o pérdida. Queda prohibido el uso de dichos bienes para fines personales o ajenos a la actividad de <b>EL EMPLEADOR</b>, salvo autorización expresa. iv. <b>Seguridad y Salud en el Trabajo:</b> Cumplir con todas las normas, procedimientos y capacitaciones en materia de seguridad y salud en el trabajo (SST) establecidas por <b>EL EMPLEADOR</b> o las autoridades competentes, reportando cualquier condición insegura o accidente. v. <b>Información y Reportes:</b> Suministrar de manera veraz, completa y oportuna toda información y documentación que le sea requerida por <b>EL EMPLEADOR</b> para fines laborales, contables, fiscales, de seguridad, SARLAFT o de cualquier otra índole legal o administrativa. vi. <b>Confidencialidad:</b> Guardar y mantener en absoluta reserva y confidencialidad toda la Información Confidencial de <b>EL EMPLEADOR</b> a la que tenga acceso, durante y después de la terminación de este contrato, tal como se detalla en la Cláusula Décima de este Contrato. vii. <b>Protección de Datos Personales:</b> Garantizar la protección de los datos personales a los que tenga acceso en virtud de sus funciones, cumpliendo estrictamente con la Política de Tratamiento de Datos Personales de <b>EL EMPLEADOR</b> y la Ley 1581 de 2012, absteniéndose de divulgar, usar o ceder datos sin la autorización de <b>EL EMPLEADOR</b>. viii. <b>No Conflicto de Intereses y Lealtad:</b> Abstenerse de realizar actividades o mantener intereses que entren en conflicto con los de <b>EL EMPLEADOR</b>, o que puedan afectar su lealtad, independencia o el debido cumplimiento de sus funciones. Esto incluye la prohibición de trabajar, asesorar o colaborar con empresas competidoras directas o indirectas de <b>EL EMPLEADOR</b> durante la vigencia del Contrato. ix. <b>Prohibición de Relaciones Sentimentales y Conflictos de Interés:</b> Abstenerse de mantener relaciones sentimentales o amorosas con personal interno, supervisores, administrativos o directivos de <b>EL EMPLEADOR</b> que puedan generar un conflicto de interés real o aparente, afectar la imparcialidad en la toma de decisiones, comprometer la confidencialidad o seguridad de la información, o impactar negativamente el ambiente laboral. El incumplimiento de esta disposición podrá dar lugar a medidas disciplinarias que podrán incluir la terminación del contrato con justa causa. x. <b>Prevención de Actividades Ilícitas (SARLAFT):</b> Cumplir con la política de prevención de lavado de activos y financiación del terrorismo (SARLAFT) de <b>EL EMPLEADOR</b>, y reportar cualquier operación sospechosa o indicio de actividad ilícita.</p>
  ...
  <p>i. <b>No Solicitación de Clientes y Modelos:</b> Abstenerse de contactar, inducir o solicitar, directa o indirectamente, a clientes, modelos, aliados, proveedores o subestudios de <b>EL EMPLEADOR</b> con el propósito de prestarles servicios similares o de la misma naturaleza que los ofrecidos por <b>EL EMPLEADOR</b>, o para que cesen su relación comercial con <b>EL EMPLEADOR</b>.</p>
  ...
  <p>iii. <b>Prohibición de Competencia Post-Contractual y su Compensación Especial: EL TRABAJADOR</b> se obliga, una vez finalizado el presente contrato por cualquier causa, a abstenerse de prestar sus servicios laborales o profesionales, de forma directa o indirecta, (ya sea como empleado, consultor, socio, accionista, contratista o cualquier otra modalidad), a empresas o personas naturales que desarrollen actividades económicas idénticas, similares o competidoras de las de <b>EL EMPLEADOR</b>, dentro del territorio de la República de Colombia, por el mismo período establecido en el encabezado de esta cláusula.</p>

  <p>Para que esta prohibición de competencia post-contractual sea plenamente válida y exigible, las Partes acuerdan y aceptan expresamente que la <b>"Compensación Económica Especial por Restricción de No Competencia"</b> a la que se refiere el Código Sustantivo del Trabajo, se reconoce y paga a <b>EL TRABAJADOR</b> de la siguiente manera durante toda la vigencia de la relación laboral, constituyendo esta la contraprestación suficiente, justa y proporcionada por la obligación de no competencia post-contractual:</p>

  <p>a) Un auxilio mensual denominado <b>"Auxilio de Protección por No Competencia"</b> por un valor de <b>CIEN MIL PESOS ($100.000) M/CTE.</b>, que será pagado mensualmente, ya sea en monto desembolsado en un solo pago o dividido en dos (2) pagos quincenales, junto con el salario. Las Partes acuerdan que, en caso de que este auxilio no sea pagado en un mes determinado, el valor correspondiente se acumulará y será pagado en el período siguiente inmediato, siempre como contraprestación por el mes o período al que corresponde. Este auxilio tendrá el carácter de pago no salarial si cumple con las condiciones legales exigidas y en sí y es pactado expresamente como tal, pero en todo caso se considerará parte esencial de la compensación especial por la restricción de no competencia.</p>

  <p>b) Un valor mensual adicional calculado como el <b>tres por ciento (3%) del Salario Mínimo Legal Mensual Vigente (SMLMV)</b>, que se causará y será pagado mensualmente junto con el salario a partir del mes siguiente a la fecha en que <b>EL TRABAJADOR</b> cumpla <b>un (1) año de servicio continuo con EL EMPLEADOR</b>. Este valor se actualizará anualmente conforme al SMLMV que se establezca para cada año y se considerá parte integral de la Compensación Económica Especial por Restricción de No Competencia. Se aclara que este porcentaje se calcula exclusivamente sobre el Salario Mínimo Legal Mensual Vigente, sin incluir ningún tipo de auxilios o beneficios no salariales.</p>

  <p>Las Partes convienen que la totalidad de los valores acumulados y pagados por los conceptos descritos en los literales a) y b) de este numeral, durante la vigencia de la relación laboral, representa la Compensación Económica Especial por Restricción de No Competencia post-contractual aquí pactada. Por consiguiente, a la terminación de este contrato, por cualquier causa, <b>EL EMPLEADOR</b> no estará obligado a realizar pagos adicionales por concepto de esta compensación especial, al entenderse que la misma ya ha sido cabalmente retribuida durante la ejecución del vínculo laboral.</p>
  ...
  <p><b>EL TRABAJADOR</b> se obliga a guardar y mantener la más estricta y absoluta reserva y confidencialidad sobre toda la "Información Confidencial" de <b>EL EMPLEADOR</b> a la que tenga acceso en virtud de su cargo o en el desarrollo de sus funciones. Se entiende por Información Confidencial, de manera enunciativa y no limitativa: información de carácter comercial, operativo, técnico, tecnológico, financiero, contable, personal, estratégico, legal, datos de clientes, modelos, subestudios, aliados, empleados, proveedores, plataformas, contraseñas, métodos de trabajo, know-how, procesos internos, software, diseños, bases de datos, contratos, comunicación pública, información de seguridad, y cualquier otra información que no sea de dominio público o que <b>EL EMPLEADOR</b> designe como confidencial.</p>
  ...
  <p>El incumplimiento de esta cláusula será considerado una falta grave y justa causa para la terminación del contrato de trabajo sin indemnización, sin perjuicio de las acciones legales (civiles y/o penales) que <b>EL EMPLEADOR</b> pueda iniciar para reclamar los perjuicios causados.</p>

  <p>Adicionalmente, a la terminación del presente Contrato por cualquier causa, <b>EL TRABAJADOR</b> se obliga a devolver a <b>EL EMPLEADOR</b> toda la Información Confidencial, documentos, copias, materiales o elementos de cualquier tipo que contengan dicha información, en cualquier formato, y eliminar de forma permanente o segura toda Información Confidencial de la cual posea copias digitales o físicas en sus dispositivos personales, correos electrónicos o cualquier otro medio bajo su control. Una vez realizado lo anterior, <b>EL TRABAJADOR</b> deberá comunicar y entregar a <b>EL EMPLEADOR</b> una <b>certificación escrita, clara y bajo la gravedad de juramento</b>, en la que conste que ha cumplido con la obligación de devolver y/o eliminar completamente la Información Confidencial, y que no retiene copias de la misma.</p>
  ...
  <p>i. El engaño por parte del trabajador mediante la presentación de certificados falsos para su admisión o tendientes a obtener un provecho indebido. ii. Todo acto de violencia, injuria, malos tratamientos o grave indisciplina en que incurra el trabajador en sus labores, contra el empleador, los miembros de su familia, el personal directivo o los compañeros de trabajo. iii.</p>

  <p>Todo acto de violencia, injuria o malos tratamientos del trabajador para con cualquier persona extraña al establecimiento, ejecutados en el sitio de trabajo o en conexión con él. iv. Todo daño material causado intencionalmente a los edificios, obras, maquinaria y materias primas, instrumentos y demás objetos relacionados con el trabajo, y toda grave negligencia que ponga en peligro la seguridad de las personas o de las cosas. v. Todo acto inmoral o delictuoso que el trabajador cometa en el taller, establecimiento o lugar de trabajo, o en el desempeño de sus labores. vi. Cualquier violación grave de las obligaciones o prohibiciones del trabajador, o cualquier falta grave calificada como tal en los pactos o convenciones colectivas, fallos arbitrales, contratos individuales o reglamentos. vii. La detención preventiva del trabajador por más de treinta (30) días, a menos que posteriormente sea absuelto; o el arresto correccional que exceda de ocho (8) días, o aun por tiempo menor, cuando la causa del arresto sea imputable al trabajador. viii. El que el trabajador revele secretos técnicos o comerciales o utilice la Información Confidencial de <b>EL EMPLEADOR</b> de manera no autorizada. ix. El bajo rendimiento o la deficiencia grave y reiterada en el desempeño de las funciones encomendadas, incluido el incumplimiento y capacitaciones proporcionadas por <b>EL EMPLEADOR</b>. x. La violación grave o reiterada de las políticas de <b>EL EMPLEADOR</b>, incluyendo, pero no limitarse a: a) <b>CÓDIGO DE CONDUCTA Y MANUAL DE CONVIVENCIA GENERAL</b> y la <b>POLÍTICA DE TRATAMIENTO DE DATOS PERSONALES (HABEAS DATA)</b>, xi. Cualquier acción u omisión que ponga en riesgo la seguridad informática, los sistemas, las plataformas o la integridad de <b>EL EMPLEADOR</b>, o que facilite accesos no autorizados a terceros. xii. La participación o complicidad en actividades que impliquen conflicto de intereses con <b>EL EMPLEADOR</b>, incluyendo la prestación de servicios similares a competidores directos o indirectos. xiii. La vinculación, promoción o participación en cualquier actividad relacionada con pornografía infantil, explotación sexual de menores, trata de personas, lavado de activos, financiación del terrorismo o cualquier otra actividad ilícita. xiv. La inclusión de <b>EL TRABAJADOR</b> en listas restrictivas nacionales o internacionales relacionadas con actividades ilícitas (OFAC, ONU, INTERPOL, SDNT, entre otras). xv. La negativa reiterada de <b>EL TRABAJADOR</b> a colaborar en los procedimientos de debida diligencia, conocimiento del cliente (KYC), auditorías o suministros de información requerida por <b>EL EMPLEADOR</b> para el cumplimiento de sus políticas de prevención de SARLAFT y ética. xvi. Cualquier acto de difamación o ultraje que afecte gravemente la imagen, reputación o patrimonio de <b>EL EMPLEADOR</b>, sus colaboradores, modelos, clientes o plataformas, incluyendo actos difamatorios u obstrucción al libre ejercicio. xvii. El incumplimiento de la prohibición de relaciones sentimentales establecida en la Cláusula Séptima, numeral ix, si se determina que generó un conflicto de interés, afectó la imparcialidad, comprometió la confidencialidad o la seguridad, o impactó negativamente el ambiente laboral.</p>

  <h3>CLÁUSULA DUODÉCIMA: AUTORIZACIÓN DE DESCUENTOS Y DEDUCCIONES</h3>

  <p><b>EL TRABAJADOR</b> autoriza de manera libre, expresa e irrevocable a <b>EL EMPLEADOR</b> para que, conforme al artículo 151 del Código Sustantivo del Trabajo y demás normas concordantes, se efectúen descuentos de sus ingresos laborales (salario y prestaciones sociales), sin exceder los límites legales (ej. hasta el 50% del salario como afecta el mínimo), por los siguientes conceptos, siempre que exista un acuerdo previo por escrito para cada caso o se derive de un daño comprobado imputable a <b>EL TRABAJADOR</b>:</p>

  <p>i. Préstamos, anticipos o créditos otorgados por <b>EL EMPLEADOR</b>. ii. Compra de productos o servicios autorizados por <b>EL EMPLEADOR</b> (ej. uniformes, tecnología, insumos personales, etc.), solicitados por <b>EL TRABAJADOR</b>. iii. Daños, deterioro o hurto de equipos, herramientas, infraestructura o bienes de <b>EL EMPLEADOR</b> causados por dolo o culpa grave de <b>EL TRABAJADOR</b>, previa comprobación y agotamiento del debido proceso. iv. Cualquier otra obligación pecuniaria expresa y previamente autorizada por escrito por <b>EL TRABAJADOR</b> o impuesta por ley o autoridad competente.</p>
  ...
  <h3>CLÁUSULA DECIMOTERCERA: DEVOLUCION DE BIENES Y PROPIEDAD</h3>

  <p>A la terminación del presente Contrato, por cualquier causa, <b>EL TRABAJADOR</b> se obliga a devolver a <b>EL EMPLEADOR</b> la totalidad de los bienes, documentos, equipos, herramientas, vehículos, dispositivos electrónicos (computadores, celulares, tabletas, etc.), software, credenciales y de acceso, información (física o digital) y demás elementos de propiedad de <b>EL EMPLEADOR</b> que se encuentren en su posesión o bajo su control, en las mismas condiciones en que los recibió, salvo el desgaste normal por el uso.</p>
  ...
  <p><b>EL EMPLEADOR</b> promoverá el bienestar emocional de <b>EL TRABAJADOR</b> mediante la implementación de un sistema de gestión de seguridad y salud en el trabajo que incluye, entre otros, la gestión de riesgos psicosociales y la provisión de atención emocional seguro y ético.</p>
  ...
  <p>Cualquier controversia o diferencia que surja entre las Partes con ocasión de la celebración, ejecución o terminación del presente Contrato, será sometida a los mecanismos de solución de conflictos establecidos en la legislación laboral colombiana, priorizando la conciliación extrajudicial ante el Ministerio del Trabajo o centros de conciliación legalmente constituidos. Si la controversia no se resuelve por estos medios, las Partes se someten a la jurisdicción de la Justicia Ordinaria Laboral de la ciudad de <b>{{ strtoupper($studio->city->city_name ?? 'Cali') }}</b>.</p>
  ...
  <p>Las Partes acuerdan expresamente que las obligaciones y derechos establecidos en las siguientes cláusulas del presente Contrato, debido a su naturaleza y con el fin de proteger los legítimos intereses de <b>EL EMPLEADOR</b>, subsistirán y serán plenamente exigibles incluso después de la terminación de la relación laboral por cualquier causa:</p>

  <p>i. <b>Cláusula Séptima:</b> Obligaciones del Trabajador (en lo referente a Confidencialidad, Protección de Datos Personales, No Conflicto de Intereses, Prevención de Actividades Ilícitas y Conducta en Plataformas y Redes Sociales, y Prohibición de Relaciones Sentimentales que comprometan la confidencialidad o intereses de la empresa). ii. <b>Cláusula Octava:</b> Propiedad Intelectual y Derechos de Autor. iii. <b>Cláusula Novena:</b> No Competencia y No Solicitación (Post-Terminación). iv. <b>Cláusula Décima:</b> Confidencialidad y No Divulgación. v. <b>Cláusula Decimotercera:</b> Devolución de Bienes y Propiedad. vi. Las obligaciones relativas a la responsabilidad por daños causados a <b>EL EMPLEADOR</b> por dolo o culpa grave de <b>EL TRABAJADOR</b>.</p>

  <p>Esta enumeración es meramente enunciativa y no taxativa, entendiéndose que cualquier otra obligación que por su naturaleza deba sobrevivir a la terminación del contrato, lo hará.</p>
  ...
  <p>Las Partes declaran haber leído, entendido y aceptado el contenido íntegro de este Contrato y sus <b>diecisiete (18) cláusulas</b> principales, así como sus anexos (el <b>CÓDIGO DE CONDUCTA Y MANUAL DE CONVIVENCIA GENERAL</b> de <b>{{ strtoupper($studio->std_company_name) }}</b> Y <b>REGLAMENTO INTERNO DE TRABAJO PARA EMPLEADOS</b> y la <b>POLÍTICA DE TRATAMIENTO DE DATOS PERSONALES (HABEAS DATA)</b>), los cuales forman parte integral del presente instrumento y de los cuales han recibido copia o acceso digital.</p>
