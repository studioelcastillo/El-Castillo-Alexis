...
class PopulateStreamsFromMasterJob implements ShouldQueue
{
    ...
    /**
     * Ejecuta el scraping de cuentas MASTER usando ms-wscrap.
     *
    ...
    {
        Log::info('[JOB] Ejecutando PopulateStreamsFromMasterJob');

        $controller->populateStreamsFromMasterWithMS($this->args);
    }
}
