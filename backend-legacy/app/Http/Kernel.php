...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'extendSessionToken' => \App\Http\Middleware\ExtendSessionToken::class,
        ...
        // last login
        'updateLastLogin' => \App\Http\Middleware\UpdateLastLogin::class,
        // Is Active
        'isActive' => \App\Http\Middleware\IsActive::class,
        'resolveTenant' => \App\Http\Middleware\ResolveTenantContext::class,
        // Internal services (ms-wscrap, ms-sso, etc.)
