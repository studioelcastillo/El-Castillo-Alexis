...
export const sGate = {
  ...
  methods: {
    ...
    getGates () {
      ...
      return [
        { gate: 'indicators-dashboard', roles: [rt, ad, cl, mdst, cont, cacc, jmon, mon] }, // comment what function does only if its necessary
        { gate: 'charts-dashboard', roles: [rt, ad, cl, mdst, cont, jmon, mon] }, // comment what function does only if its necessary
        ...
        { gate: 'menu-studios_models', roles: [rt, ad, mdst, cont, cacc, entr, jmon, mon] }, // comment what function does, only if its necessary
        { gate: 'show-studios_models', roles: [rt, ad, mdst, cont, cacc, entr, jmon, mon] }, // comment what function does, only if its necessary
        ...
        //models_accounts
        { gate: 'menu-models_accounts', roles: [rt, ad, mdst, cacc, cont, jmon, mon] }, // comment what function does, only if its necessary
        { gate: 'show-models_accounts', roles: [rt, ad, mdst, cacc, cont, jmon, mon] }, // comment what function does, only if its necessary
        ...
        //models liquidation
        { gate: 'menu-models_liquidation', roles: [rt, ad, cl, mdst, cont, jmon, mon] }, // comment what function does, only if its necessary
