      ...
      <div class="col-12">
        ...
        <q-card v-show="openGate('menu-models_liquidation', sUser.prof_id)" flat bordered class="my-card">
          <q-card-section>
              ...
              <template v-slot:body="props">
                ...
                >
                  <q-td auto-width align="center">
                    ...
                    <!-- Si no es un usuario estudio, ni modelo y no se paga desde master -->
                    <span v-else-if="!openGate('is-studio', sUser.prof_id) && !openGate('is-model', sUser.prof_id) && !props.row.std_ally_master_pays">
                  ...
                  <q-td key="user_name" :props="props">
                    <span>
                      <q-avatar v-if="props.row.user_bank_entity == 'BANCO BBVA'" size="xs" color="white" style="border: 1px solid #444444" ><img src="/icons/bbva-logo.png"><q-tooltip :delay="100" :offset="[0, 10]">BBVA</q-tooltip></q-avatar>
                      <q-avatar v-if="props.row.user_bank_entity == 'BANCOLOMBIA'" size="xs" color="white" style="border: 1px solid #444444" ><img src="/icons/bancolombia-logo.png"><q-tooltip :delay="100" :offset="[0, 10]">BANCOLOMBIA</q-tooltip></q-avatar>
                      <q-avatar v-if="props.row.user_bank_entity == 'SCOTIABANK'" size="xs" color="white" style="border: 1px solid #444444" ><img src="/icons/scotiabank-logo.png"><q-tooltip :delay="100" :offset="[0, 10]">SCOTIABANK</q-tooltip></q-avatar>
                      <q-avatar v-if="props.row.user_bank_entity == 'BANCO AV VILLAS'" size="xs" color="white" style="border: 1px solid #444444" ><img src="/icons/avvillas-logo.jpg"><q-tooltip :delay="100" :offset="[0, 10]">AVVILLAS</q-tooltip></q-avatar>
                      <q-avatar v-if="props.row.user_bank_entity == 'NEQUI'" size="xs" color="white" style="border: 1px solid #444444" ><img src="/icons/nequi-logo.jpg"><q-tooltip :delay="100" :offset="[0, 10]">NEQUI</q-tooltip></q-avatar>
                      <q-avatar v-if="props.row.user_bank_entity == 'BANCO DAVIVIENDA'" size="xs" color="white" style="border: 1px solid #444444" ><img src="/icons/davivienda-logo.png"><q-tooltip :delay="100" :offset="[0, 10]">DAVIVIENDA</q-tooltip></q-avatar>
                      <q-avatar v-if="props.row.user_bank_entity == 'FALABELLA'" size="xs" color="white" style="border: 1px solid #444444" ><img src="/icons/falabella-logo.webp"><q-tooltip :delay="100" :offset="[0, 10]">FALABELLA</q-tooltip></q-avatar>
                      <q-avatar v-if="props.row.user_bank_entity == 'AHORRO A LA MANO'" size="xs" color="white" style="border: 1px solid #444444" ><img src="/icons/ahorro-a-la-mano-logo.png"><q-tooltip :delay="100" :offset="[0, 10]">AHORRO A LA MANO</q-tooltip></q-avatar>
                      <q-icon v-else-if="!props.row.user_bank_entity" name="error" size="sm" class="text-red"><q-tooltip :delay="100" :offset="[0, 10]">No posee cuenta registrada</q-tooltip></q-icon>
                      {{ props.row.user_name }} {{ props.row.user_surname }}
                      <a v-if="openGate('show-users', sUser.prof_id)" @click="goTo('users/show/' + props.row.user_id, '_blank')" style="cursor:pointer;">
                        <q-icon name="open_in_new" size="sm" class="text-teal-8">
                          <q-tooltip :delay="100" :offset="[0, 10]">Consultar modelo</q-tooltip>
                        </q-icon>
                      </a>
                    </span>
                  </q-td>
                  <q-td key="std_name" :props="props">
                    <span>
                      ...
                      <a v-if="openGate('show-studios', sUser.prof_id)" @click="goTo('studios/show/' + props.row.std_id, '_blank')" style="cursor:pointer;">
                        <q-icon name="open_in_new" size="sm" class="text-teal-8">
                          <q-tooltip :delay="100" :offset="[0, 10]">Consultar studio</q-tooltip>
                        </q-icon>
                      </a>
                    </span>
                  </q-td>
                  ...
                  <q-td key="action" :props="props">
                    <a v-if="(!isSubgrid || parentMode == 'edit')" class="text-red" style="cursor: pointer;" @click="downloadLiquidationPdf(props.row.user_id, 'byCompany')"> <q-icon size="sm" name="picture_as_pdf"/>
                      <q-tooltip :offset="[0, 10]">Descargar PDF - Liquidación por empresa</q-tooltip>
                    </a>
                    <a v-if="(!isSubgrid || parentMode == 'edit')" class="text-red" style="cursor: pointer;" @click="downloadLiquidationPdf(props.row.user_id, 'byPage')"> <q-icon size="sm" name="picture_as_pdf"/>
                      <q-tooltip :offset="[0, 10]">Descargar PDF - Liquidación por página</q-tooltip>
                    </a>
                    <a v-if="(!isSubgrid || parentMode == 'edit')" class="text-red" style="cursor: pointer;" @click="downloadPaymentNotePdf(props.row.user_id)"> <q-icon size="sm" name="picture_as_pdf"/>
                    ...
                    >
                      ...
                      <template v-slot:body="subprops">
                        <q-tr :props="subprops">
                          ...
                          <q-td key="modacc_username" :props="subprops">{{ subprops.row.modacc_username }}</q-td>
                      ...
                      <template v-slot:bottom-row>
                        <q-tr>
                          ...
                          <q-td key="modacc_username"><b></b></q-td>
                ...
                <q-tr v-if="dataset.length - 1 == dataset.indexOf(props.row)" style="background-color: black; color: white;">
                  ...
                  <q-td key="user_name"><b>{{ dataset.length }} modelos</b></q-td>
                  <q-td key="std_name"><b>Totales</b></q-td>
                  <q-td key="owner_name"></q-td>
            ...
            <q-card-section v-if="openGate('generate_file-models_liquidation', sUser.prof_id)">
        ...
        <!-- payments -->
        <q-card v-if="openGate('generate_file-models_liquidation', sUser.prof_id)" flat bordered class="my-card">
          <q-form @submit="onSubmit" class="q-gutter-md">
            <q-card-section>
              <div class="row q-col-gutter-sm">
                <div class="col-xs-12 col-sm-12">
                  <q-card flat bordered class="my-card">
                    <q-card-section>
                      ...
                      <div v-if="openGate('is-studio', sUser.prof_id) && (report.std_ids.length == 0 || report.std_ids.some(std => std.ally_master_pays))" class="row q-col-gutter-sm">
                        <div class="col-xs-12 col-sm-12">
                          <q-card flat bordered class="my-card bg-blue-1 text-black">
                            <q-card-section>
                              <div class="q-gutter-sm">
                                <div class="flex" style="gap: 10px;">
                                  <q-icon name="info" size="sm" class="text-blue"/><q-tooltip :delay="100" :offset="[0, 10]">Tiempo no completado</q-tooltip>
                                  <p v-if="report.std_ids.length == 0" class="subtitle" style="margin: 0 0 0px;">Debe seleccionar un estudio para descargar archivo de pago</p>
                                  <p v-else class="subtitle" style="margin: 0 0 0px;">La nómina de este estudio se paga mediante el estudio master.</p>
                                </div>
                              </div>
                            </q-card-section>
                          </q-card>
                      ...
                      <div v-else class="flex" style="gap: 40px; flex-direction: column;">
                        <div class="row q-col-gutter-sm">
                          <div class="col-xs-12 col-sm-12">
        ...
        <br>
        <AccountingArchive 
          v-if="openGate('download-models-reports', sUser.prof_id)" 
  ...
  methods: {
    ...
    async getStudios () {
      ...
      if (this.studios.length == 2) {
        this.report.std_ids = [this.studios[1]]
    ...
    async onSubmit () {
      ...
      try {
        ...
        if (this.report.std_ids && this.report.std_ids.length > 0) {
          for (var i = 0; i < this.report.std_ids.length; i++) {
            query += '&std_ids[]=' + this.report.std_ids[i].value
          }
        }
        ...
        var response = await LiquidationService.getModelsLiquidation({ query: query, token: this.decryptSession('token') })
    ...
    downloadLiquidationPdf (idModel, type) {
      // download
      var url = this.getApiUrl('/api/liquidations/models/pdf/' + idModel + '/' + type + '?access_token=' + this.decryptSession('token') + '&report_since=' + this.report.report_period.since + '&report_until=' + this.report.report_period.until + '&tz=' + (Intl.DateTimeFormat().resolvedOptions().timeZone) + '&tzo=' + new Date().getTimezoneOffset())
      var win = window.open(url, '_blank')
      win.focus()
    },
    downloadCertificationPdf (idModel) {
      // download
      var url = this.getApiUrl('/api/liquidations/models/certification/pdf/' + idModel + '?access_token=' + this.decryptSession('token') + '&report_since=' + this.report.report_period.since + '&report_until=' + this.report.report_period.until + '&tz=' + (Intl.DateTimeFormat().resolvedOptions().timeZone) + '&tzo=' + new Date().getTimezoneOffset())
      var win = window.open(url, '_blank')
      win.focus()
    },
    downloadPaymentNotePdf (idModel) {
      // download
      var url = this.getApiUrl('/api/liquidations/models/payment_note/pdf/' + idModel + '?access_token=' + this.decryptSession('token') + '&report_since=' + this.report.report_period.since + '&report_until=' + this.report.report_period.until + '&tz=' + (Intl.DateTimeFormat().resolvedOptions().timeZone) + '&tzo=' + new Date().getTimezoneOffset())
      var win = window.open(url, '_blank')
      win.focus()
    },
    liquidationExport() {
      ...
      if (this.selectedRows.length > 0) {
        for (var i = 0; i < this.selectedRows.length; i++) {
          query += '&user_id[]=' + this.selectedRows[i].user_id
        }
      }
      if (this.report.orderBy.value) {
        query += '&orderBy=' + this.report.orderBy.value
      ...
      // download
      var url = this.getApiUrl('/api/liquidations/models/export?access_token=' + this.decryptSession('token') + '&' + query)
      var win = window.open(url, '_blank')
      win.focus()
    },
    downloadPaymentPlain() {
      this.$q.dialog({
        ...
        // download
        var url = this.getApiUrl('/api/liquidations/models/payment_plain?access_token=' + this.decryptSession('token') + '&' + query)
        var win = window.open(url, '_blank')
        win.focus()
	...
	downloadResumenPdf() {
      ...
      // download
      var url = this.getApiUrl('/liquidation/summary-pdf?' + query.substring(1))
      var win = window.open(url, '_blank')
      win.focus()
    }
  }
