  ...
  <div class="q-pa-md">
    ...
    <div v-else>
          ...
          <q-card flat bordered class="my-card">
            <q-card-section>
              ...
              >
                ...
                <div
                  v-if="[1, 11].includes(sUser.prof_id)"
      ...
      <div v-if="openGate('indicators-dashboard', sUser.prof_id)" class="row">
        <div
          v-if="[1, 2, 3, 4, 5, 11].includes(sUser.prof_id)"
          ...
          <q-card flat bordered class="my-card" style="overflow-y: auto">
            <q-card-section class="bg-black text-white">
              <div class="text-h5 text-weight-bolder">
                Tasa de cambio
                {{
                  indicatorsList.trm ? "(" + indicatorsList.trm.date + ")" : ""
                }}
              </div>
            </q-card-section>
              ...
              <div class="col-md-12 col-xs-12">
                <div class="row">
                  <q-card
                    ...
                    flat
                    bordered
                    class="col-md-6 col-xs-12 bg-grey-1"
                    :class="
                      [1, 2, 3, 4, 5, 11].includes(sUser.prof_id)
                        ? {}
                        : 'col-md-12'
                    "
                  >
            ...
            <div class="row">
              ...
              <div bordered class="col-md-3 col-xs-12">
                <q-card
                  flat
                  bordered
                  class="col-md-4 col-xs-6 bg-grey-1"
                  style="height: 100%"
                >
                  <q-card-section
                  ...
                  >
                    ...
                    >
                      <div
                        ...
                        :style="{
                          ...
                          backgroundSize: [4, 5].includes(sUser.prof_id)
                            ? 'cover'
                            : 'contain',
                    ...
                    <br />
                    <h5 v-if="[4, 5].includes(sUser.prof_id)">
                      {{ sUser.user_name }} {{ sUser.user_surname }}
                    </h5>
                    <h5 v-else-if="[2].includes(sUser.prof_id)">
                      {{ studioData.std_name }}
                    </h5>
              ...
              <div class="col-md-9 col-xs-12">
                <q-card
                  v-if="[6].includes(sUser.prof_id)"
                  flat
                  bordered
                  class="col-md-12 col-xs-12 bg-grey-1"
                  style="height: 100%"
                >
                  <q-card-section class="text-center bg-white">
                    <h6 class="is-size-3">
                      🍰 <small>Próximos cumpleaños</small> 🍰
                    </h6>
                  </q-card-section>
                  <q-separator />
                  <!-- notice "border-radius-inherit" below; it's important when in a QCard -->
                    ...
                    <div style="display: flex; flex-direction: column">
                      <table class="q-pl-md">
                        <tr
                          v-for="(
                            model, index
                          ) in indicatorsList.next_happy_birthdays"
                          v-bind:key="index"
                        >
                ...
                <div v-else class="row">
                  <q-card
                    flat
                    bordered
                    class="col-md-4 col-xs-12 bg-grey-1"
                    :class="
                      [1, 2, 3, 11].includes(sUser.prof_id) ? {} : 'col-md-12'
                    "
                  >
                    <q-card-section class="text-center bg-white">
                      <h6 class="is-size-3">
                        <small>Ganancia en (USD)</small>
                      </h6>
                    </q-card-section>
                    <q-separator />
                    <!-- notice "border-radius-inherit" below; it's important when in a QCard -->
                    <q-card-section
                      class="border-radius-inherit flex flex-center"
                    >
                      <div>
                        <h4>
                          <small
                            >$
                            {{ miles(indicatorsList.sum_earnings_usd) }}</small
                          >
                        </h4>
                      </div>
                    ...
                    >
                      <div>
                        <h4>
                          <small
                            >$
                            {{ miles(indicatorsList.sum_earnings_eur) }}</small
                          >
                        </h4>
                      </div>
                    </q-card-section>
                    ...
                    >
                      <div>
                        <h4>
                          <small
                            >$
                            {{ miles(indicatorsList.sum_earnings_cop) }}</small
                          >
                        </h4>
                      </div>
                      <!-- <a class="text-green" style="cursor: pointer;"><q-icon size="md" name="trending_up"/></a> -->
                  ...
                  <q-card
                    v-if="[1, 2, 3, 11].includes(sUser.prof_id)"
                    flat
                    bordered
                    class="col-md-4 col-xs-12 bg-grey-1"
                  >
                    ...
                    >
                      <div>
                        <h4>
                          <small>{{ miles(indicatorsList.sum_studios) }}</small>
                        </h4>
                      </div>
                    </q-card-section>
                  </q-card>
                  ...
                  >
                    ...
                    >
                      <div>
                        <h4>
                          <small>{{
                            miles(indicatorsList.sum_studio_models)
                          }}</small>
                        </h4>
                      </div>
                    </q-card-section>
                  ...
                  >
                    <q-card-section class="text-center bg-white">
                      <h6 class="is-size-3">
                        <small>Cuartos (% de ocupación)</small>
                      </h6>
                    </q-card-section>
                    <q-separator />
                    <!-- notice "border-radius-inherit" below; it's important when in a QCard -->
                    ...
                    >
                      <div>
                        <h4>
                          <small
                            >{{ miles(indicatorsList.n_room) }} ({{
                              miles(
                                (indicatorsList.room_busy /
                                  indicatorsList.n_room) *
                                  100
                              )
                            }}%)</small
                          >
                  ...
                  <q-card
                    v-if="[1, 2, 3, 7, 8, 11].includes(sUser.prof_id)"
                    flat
                    bordered
                    class="col-md-6 col-xs-12 bg-grey-1"
                  >
                    ...
                    >
                      <div style="display: flex; flex-direction: column">
                        <div
                          v-for="(model, index) in indicatorsList.top_models"
                          v-bind:key="index"
                        >
                          <div
                            style="
      ...
      <!-- model goals -->
      <div
        v-if="[4, 5].includes(sUser.prof_id)"
            ...
            <q-card-section>
              ...
              >
                <q-card
                  flat
                  bordered
                  class="col-md-12 col-xs-6 bg-white text-black"
                >
                  <q-card-section class="text-center bg-primary text-white">
                    <h6 class="is-size-3">
                      <small
                        v-if="
                          modelGoalsTable.dataset &&
                          modelGoalsTable.dataset[0] &&
                          modelGoalsTable.dataset[0].stdmod_commission_type ==
                            'SATELITE'
                        "
                        >Metas</small
                      >
                        ...
                        <small>
                          Ganancia actual: ${{
                            miles(
                              modelGoalsTable.dataset &&
                                modelGoalsTable.dataset[0]
                                ? modelGoalsTable.dataset[0].sum_earnings
                                : 0
                            )
                          }}
                          <span
                            v-if="
                              ...
                              modelGoalsTable.dataset[0] &&
                              modelGoalsTable.dataset[0].sum_earnings >
                                modelGoalsTable.dataset[0].sum_goal
                            "
                            >✅</span
                          >
                        </small>
                  ...
                  >
                    <div
                      v-if="modelGoalsTable.dataset[0].goals"
                      class="row"
                      style="
                        width: 100%;
                        display: flex;
                    ...
                    >
                      <div
                        v-for="(goal, index) in modelGoalsTable.dataset[0]
                          .goals"
                        v-bind:key="index"
                        class="col-sm"
                      >
                        ...
                        <q-card
                          flat
                          class="col-md-12 col-xs-6 text-black"
                          style="
                        ...
                        <q-linear-progress
                          ...
                          size="25px"
                          :value="
                            goal.since < modelGoalsTable.dataset[0].sum_earnings
                              ? modelGoalsTable.dataset[0].sum_earnings /
                                (goal.until + 1)
                              : 0
                          "
                    ...
                    >
                      <div class="col-sm">
                        <q-linear-progress size="25px" :value="0" stripe>
                          <div class="absolute-full flex flex-center">
                            <q-badge
                              color="white"
                              :text-color="getExecutionColor(0)"
                              :label="miles(0) + '%'"
                            />
                          </div>
                        </q-linear-progress>
                  ...
                  >
                    <q-linear-progress
                      v-if="
                        modelGoalsTable.dataset && modelGoalsTable.dataset[0]
                      "
                      size="25px"
                      :value="
                        modelGoalsTable.dataset[0].sum_earnings /
                      ...
                      :color="
                        getExecutionColor(
                          modelGoalsTable.dataset[0].sum_goal != 0
                            ? (modelGoalsTable.dataset[0].sum_earnings /
                                modelGoalsTable.dataset[0].sum_goal) *
                                100
                            : 0
                    ...
                    <q-linear-progress v-else size="25px" :value="0" stripe>
                      <div class="absolute-full flex flex-center">
                        <q-badge
                          color="white"
                          :text-color="getExecutionColor(0)"
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      v-if="
                        studioGoalsTable.dataset && studioGoalsTable.dataset[0]
                      "
                    >
                      <h4>
                        <small>
                          Ganancia actual: ${{
                            miles(
                              studioGoalsTable.dataset &&
                                studioGoalsTable.dataset[0]
                                ? studioGoalsTable.dataset[0].sum_earnings
                                : 0
                            )
                          }}
                          <span
                            v-if="
                              ...
                              studioGoalsTable.dataset[0] &&
                              studioGoalsTable.dataset[0].sum_earnings >
                                studioGoalsTable.dataset[0].sum_goal
                            "
                            >✅</span
                          >
                        </small>
                  ...
                  >
                    <div
                      v-if="studioGoalsTable.dataset[0].goals"
                      class="row"
                      style="
                        width: 100%;
                        display: flex;
                    ...
                    >
                      <div
                        v-for="(goal, index) in studioGoalsTable.dataset[0]
                          .goals"
                        v-bind:key="index"
                        class="col-sm"
                      >
      ...
      >
        ...
        >
          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              <q-td key="user_identification" :props="props">{{
                props.row.user_identification
              }}</q-td>
              <q-td key="user_name" :props="props">{{
                props.row.user_name
              }}</q-td>
              <q-td key="user_surname" :props="props">{{
                props.row.user_surname
              }}</q-td>
              <q-td key="sum_goal" :props="props">{{
                miles(props.row.sum_goal)
              }}</q-td>
              <q-td key="sum_earnings" :props="props">{{
                miles(props.row.sum_earnings)
              }}</q-td>
              <q-td key="goal_indicator" :props="props">
                <q-linear-progress
                  size="25px"
                  :value="props.row.sum_earnings / props.row.sum_goal"
                  :color="
                    getExecutionColor(
                      props.row.sum_goal != 0
                        ? (props.row.sum_earnings / props.row.sum_goal) * 100
                        : 0
                    )
                  "
                >
                  <div class="absolute-full flex flex-center">
                    <q-badge
                      ...
                      :text-color="
                        getExecutionColor(
                          props.row.sum_goal != 0
                            ? (props.row.sum_earnings / props.row.sum_goal) *
                                100
                            : 0
                        )
                      "
        ...
        <div class="col-md-12 col-xs-12">
          ...
          >
            <q-card-section>
              <div class="text-h5 text-weight-bolder">
                Tareas
                <!-- <a class="text-green" style="cursor: pointer;" @click="goToRole('admin/user/new')"> <q-icon name="add_box"/> </a> -->
              </div>
            </q-card-section>
            ...
            >
              ...
              <div v-for="task in tasksList" :key="task.task_id">
                <q-item>
                  ...
                  <q-item-section side>
                    <div
                      v-if="task.task_type === 'AVAILABLE_ROOM'"
                    ...
                    >
                      <q-btn
                        ...
                        @click="goTo('studios/edit/' + task.task_key_id)"
                      />
                    </div>
                    <div
                      v-if="task.task_type === 'MISSING_BANK_INFO'"
                      class="text-grey-8 q-gutter-xs"
                    >
                      <q-btn
                        size="12px"
                        ...
                        color="dark-page"
                        text-color="dark-page"
                        @click="goTo('users/edit/' + task.task_key_id)"
                      />
                    </div>
                    <div
                      v-if="task.task_type === 'PETITIONS'"
                      class="text-grey-8 q-gutter-xs"
                    >
                      <q-btn
                        size="12px"
                        ...
                        color="dark-page"
                        text-color="dark-page"
                        @click="goTo('petitions/edit/' + task.task_key_id)"
                      />
                    </div>
                    <div
                      v-if="task.task_type === 'BIRTHDAYS'"
                      class="text-grey-8 q-gutter-xs"
                    >
                      <q-btn
                        size="12px"
                    ...
                    <div
                      v-if="task.task_type === 'DOCUMENTS_MISSING'"
                      class="text-grey-8 q-gutter-xs"
                    >
                      <q-btn
                        size="12px"
                  ...
                  <center>
                    <q-item-label lines="1">
                      <span class="text-weight-medium text-primary"
                        >¡Has finalizado todas las tareas!</span
                      >
                      <!-- <span class="text-grey-8"> - GitHub repository</span> -->
                    </q-item-label>
                  </center>
    ...
    <q-dialog v-model="showTransactionDialog" persistent>
      <q-card style="min-width: 350px">
        <transaction-form
          is-dialog="true"
          :parent-id="sUser.user_id"
          transfer-group-prop="EGRESOS"
...
export default {
      ...
      modelGoalsTable: {
        ...
        columns: [
          ...
          },
          {
            ...
            label: "Indicador",
            align: "left",
            field: (row) => (row.sum_earnings || 0) / (row.sum_goal || 1),
            sortable: true,
          },
        ],
      },
  ...
  methods: {
    async getSelects() {
      try {
        ...
        this.periods = periods.map((p) => ({
          label: `Periodo desde ${p.period_start_date} hasta ${p.period_end_date}`,
          since: p.period_start_date,
          until: p.period_end_date,
          value: p.period_id,
        }));
    ...
    async getTasks() {
      try {
        const { data } = await DashboardService.getTasks(this.sUser.user_id);
        this.tasksList = data || [];
    ...
    async getCharts() {
      try {
        ...
        if ([4, 5].includes(this.sUser.prof_id)) {
          params.user_id = this.sUser.user_id;
        }
        const { data: charts } = await DashboardService.getCharts(params);
        if (charts) {
          this.chartOptsStreamEarnings.series = charts.series || [];
          this.chartOptsStreamEarnings.xAxis.categories =
            charts.categories || [];
        }

        const { data: modelGoals } = await DashboardService.getModelGoals(
          params
        );
        this.modelGoalsTable.dataset = modelGoals || [];

        const { data: studioGoals } = await DashboardService.getStudioGoals(
          params
        );
